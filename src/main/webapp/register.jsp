...
<html>
    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="col-md-4 register-fix border centre-div">

                <h2 class="text-center">Register</h2>
                <form method="POST"  action="Register">
                    <div class="form-group">
                        <label>User Name</label>
                        <input type="text" required="required" class="form-control" name="username" placeholder="">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="text"  required="required" class="form-control" name="email" placeholder="email"  <% if (request.getAttribute("email") != null) {%> value="<%=request.getAttribute("email")%>" <%}%> >
                    </div>
